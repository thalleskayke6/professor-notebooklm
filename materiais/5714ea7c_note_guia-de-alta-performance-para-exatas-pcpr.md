...
### 3. Estudo Ativo e a Regra do 80/20
**Assistir a videoaulas não é estudar** [23]. A explicação do professor traz apenas o *entendimento* [24, 25]. Para você realmente *aprender*, o seu estudo precisa ser **ativo** [26]. Por isso, nossa rotina será dividida em **20% de teoria e 80% de exercícios** [27]. Sempre que eu te apresentar um conceito e um exemplo, seu dever será **pausar o rascunho e forçar a sua mente a tentar resolver o exercício sozinho antes de olhar a resolução** [28, 29]. O erro faz parte do jogo e é a única forma de mapear suas fraquezas para corrigi-las a tempo [30, 31].

### 4. Ordem Correta de Estudo
Um erro fatal em exatas é estudar os conteúdos na ordem errada [32, 33]. Por exemplo, não adianta querer começar por lógica de argumentação se você ainda não domina proposições e tabela verdade [34]. Portanto, conforme você me enviar os tópicos, farei pequenos ajustes para garantir que estejamos subindo um degrau de cada vez [34]. Além disso, quando estruturar sua rotina semanal de estudos, lembre-se de **mesclar exatas com matérias de humanas** para manter os dois hemisférios do seu cérebro estimulados e evitar o cansaço mental [35-39].
...
🚀 Qual é o **primeiro assunto** do seu edital que vamos detonar hoje?